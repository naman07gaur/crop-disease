...
//         "http://localhost:9100/api/v3/health_assessment",
//         formData,
//         {
//           headers: {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: `url('https://unsplash.com/photos/a-close-up-of-a-large-green-leafy-plant-2pTYBhn6U3s')`,
      }}
    >
      <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-6 w-full max-w-3xl">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-green-500 text-white font-bold py-2 rounded hover:bg-green-700 transition duration-300"
          >
            Detect Disease
          </button>
        </form>
